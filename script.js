function deliveryLocation() {
  ...
  submitBtn.addEventListener("click", function () {
    ...
    pizza.pizzaToppings = $("#pizzaToppings").select2("val");
  
    pizza.pizzaQuantity = parseInt(
    ...
    if (check) {
      ...
      document.getElementById("pizzaToppingPrice").innerHTML =
        pizza.getPizzaToppingTotalPrice();
      document.getElementById("yourPizzaQuantity").innerHTML =
        pizza.pizzaQuantity;
  ...
  function checkIfEmpty(object) {
    if (object.name.trim() == "") {
      ...
      return false;
    } else if (isNaN(object.pizzaQuantity)) {
